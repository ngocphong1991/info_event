...
// custom scrollbar
    $(".sidebar-scroll").niceScroll({styler:"fb",cursorcolor:"#4A8BC2", cursorwidth: '7', cursorborderradius: '0px', background: '#404040', cursorborder: ''});
...
// theme switcher
    ...
    var setColor = function (color) {
        var source = $('#style_color').attr("data-source");
        $('#style_color').attr("href", source+"style-" + color + ".css");
    }
